...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.faceUp) {
        UIImage *faceImage = [UIImage imageNamed:[NSString stringWithFormat:@"%@%@", [self.playingCard rankString], self.playingCard.suit]];
        if (faceImage) {
...
- (void)drawPips
{
    if ((self.playingCard.rank == 1) || (self.playingCard.rank == 5) ||
        (self.playingCard.rank == 9) || (self.playingCard.rank == 3)) {
        [self drawPipsWithHorizontalOffset:0
                            verticalOffset:0
                        mirroredVertically:NO];
    }
    if ((self.playingCard.rank == 6) || (self.playingCard.rank == 7) || (self.playingCard.rank == 8)) {
    ...
    if ((self.playingCard.rank == 4) || (self.playingCard.rank == 5) || (self.playingCard.rank == 6) ||
        (self.playingCard.rank == 7) || (self.playingCard.rank == 8) || (self.playingCard.rank == 9) ||
